...
<https://compassdocs.io/.well-known/security.txt>, and the full disclosure
policy lives in our [Trust Center](https://trust.compassdocs.io/#disclosure).
...
for how CompassDocs protects credentials, sessions, and backups.
