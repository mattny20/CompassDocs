...
const SECTIONS = [
  { href: "/admin", label: "System", icon: <Monitor className={ICON} />, keywords: "version update health status docker diagnostics metrics prometheus probes healthz readyz observability" },
