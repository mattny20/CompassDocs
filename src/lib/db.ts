...
const SCHEMA_SQL = `
  ...
  -- (Placed after users and documents, which it references. 1.1.0 declared
  -- it earlier in this file, which worked on every existing database and
  -- failed on a fresh one -- the 1.1.1 fix.)
